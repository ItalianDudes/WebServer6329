package it.italiandudes.webserver6329.dnd5e.controller;

import it.italiandudes.webserver6329.dnd5e.data.sheet.enums.*;
import it.italiandudes.webserver6329.dnd5e.data.sheet.item.*;
import it.italiandudes.webserver6329.core.misc.RandomNumberGenerator;
import it.italiandudes.webserver6329.core.security.WebServer6329UserDetails;
import it.italiandudes.webserver6329.dnd5e.data.DND5ECampaign;
import it.italiandudes.webserver6329.dnd5e.data.sheet.DND5ESheet;
import it.italiandudes.webserver6329.dnd5e.data.sheet.enums.*;
import it.italiandudes.webserver6329.dnd5e.data.sheet.item.*;
import it.italiandudes.webserver6329.dnd5e.data.sheet.misc.DND5EDiceRoll;
import it.italiandudes.webserver6329.dnd5e.data.sheet.proficiency.DND5EWeaponProficiency;
import it.italiandudes.webserver6329.dnd5e.repository.DND5ECampaignRepository;
import it.italiandudes.webserver6329.dnd5e.repository.DND5ESheetRepository;
...
public final class ControllerDND5ESheets {
    ...
    private String sheets(@PathVariable(name = "campaign-id") Long campaignID, @AuthenticationPrincipal WebServer6329UserDetails userDetails, Model model) {
